...
// httpOnly :true gives only access to the backend frontend cant see it
// secure:true only works on https and doesnt works on http
// sameSite:"strict" protects from csrf attacks
// csrf attacks occur when cookies are automatically sent across sites without user intent.
// when we use cors we send accessToken through headers like helmets but it may cause xss attacks
